...
export default {
    ...
    setup(props) {
        ...
        const fetchProjectsMember = async () => {
            try {
                const data = await getProjectsMember();
        ...
        return { onTask, closeTask, pjId, projects, projectTasks, activeTab }
    }
}
</script>