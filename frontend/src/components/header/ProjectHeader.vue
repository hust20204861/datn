<template>
    <div class="flex items-center">
        <h1 class="font-bold text-[1.5rem] ml-[2%] absolute">{{t('2')}}</h1>

        <button v-show="onShow" class="p-2 bg-green-600 text-white hover:bg-green-700 rounded-xl ml-9 absolute right-5 flex items-center justify-center" @click="createProject">
            <IconPlus size="20" class="text-white mr-2"/>
            {{t('5')}}
        </button>
